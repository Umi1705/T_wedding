...
//output the result in an elemnt with is="demo"
document.getElementById("time").innerHTML = 
    "<div class='conrtainer'><div class='days block'>" +
    days + 
    "<br>Days</div>" + 
...
console.log("\n\n%c SAVE THE DATE: 7TH DECEMBER 2024", styles);